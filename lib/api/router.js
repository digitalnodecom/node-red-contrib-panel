...
router.put('/databases/:dbId/journal-mode', databasesController.changeJournalMode);
router.post('/databases/:dbId/vacuum', databasesController.vacuumDatabase);
router.post('/databases/:dbId/analyze', databasesController.analyzeDatabase);
